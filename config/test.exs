...
config :financial_agent, FinancialAgent.Repo,
  ...
  types: FinancialAgent.PostgrexTypes

# We don't run a server during test. If one is required,
# you can enable the server option below.
config :financial_agent, FinancialAgentWeb.Endpoint,
  http: [ip: {127, 0, 0, 1}, port: 4002],
  secret_key_base: "zItqEGNe1kko2bpEhj9/+dwFxuH2d4+ylOlNy3ys8n2VYBiGdyS82QMB2qabpDDo",
  server: false
...
config :financial_agent, Oban, testing: :inline
